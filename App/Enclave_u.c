...
static const struct {
	...
	13,
	{
		...
		(void*)(uintptr_t)Enclave_ocall_generic,
...
sgx_status_t ecall_main(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t ecall_big_malloc(sgx_enclave_id_t eid, unsigned long long* retval)
{
	sgx_status_t status;
	ms_ecall_big_malloc_t ms;
